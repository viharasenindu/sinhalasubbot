...
හායි සිංහල සබ් 25,000 කට අදික Telegram හී   විශාලතම  හා   ප්‍රථම  සිංහල සබ්ටයිල් බොට් එකට ඔබව සාදරෙන් පිලිගන්නවා 🙏 \n මම ඉන්ලයින් ක්‍රමයට හා  auto filter විදිහට වැඩ කරන බොට් කෙනෙක්. ❤️ 
\n ඔයාට ඉන්ලයින් සර්ච් එක වගේම  බොට් එකට අදාල නම එවීම මගින් සබ් ගන්න පුලුවන් \n ඔයාට දැන ගන්න තියන දෙවල් බලන්න පහත  HELP බටන් එක යුස් කරන්න ❤️
\n  ‼️සමහර සිරීස් වල සබ් ෆුල් සීසන් එකම එක සිප් එක්ක ඇති සබ් එක ගන්න කලින් එක බලලා ඉන්න \nTV series එකක් නම් Season එකේ අංකෙත් S01 වගේ දෙන්න. \n   (එතකොට හොයාගන්න ලේසියි.) 
/n කරුනාකර  filter  හරහා හො inline search  හරහා සබ් ගන්නවා නම් කතාවෙ නම පමනක් ඇතුලත් කරන්න වෙන කිසිවක් නැතුව... /n @SSB_PROJECTS
 """
    HELP_TXT = """ 𝙷𝙴𝚑  {}
